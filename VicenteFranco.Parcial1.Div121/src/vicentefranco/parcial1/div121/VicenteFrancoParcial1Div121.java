...
public class VicenteFrancoParcial1Div121 {
    ...
    public static void cargarMuseo(PersonalMuseo p) {
        ...
        try {
            ...
            ExperimentoGuiado experimento = new ExperimentoGuiado("EXPERIMENTO A", "UBICACION EXPERIMENTO A", TipoPublico.NINIOS, EstacionAño.PRIMAVERA);
            ExperimentoGuiado experimento2 = new ExperimentoGuiado("EXPERIMENTO B", "UBICACION EXPERIMENTO B", TipoPublico.ADOLESCENTES, EstacionAño.INVIERNO);
            ExperimentoGuiado experimento3 = new ExperimentoGuiado("EXPERIMENTO C", "UBICACION EXPERIMENTO C", TipoPublico.ADULTOS, EstacionAño.VERANO);
        ...
        } catch (ModuloRepetidoException ex) {
            System.out.println(ex.getMessage());
        }
